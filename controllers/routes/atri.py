...
class Atri:
	def __init__(self, state: Any):
		...
		self.ServiceHead = state["ServiceHead"]
		self.Flex49 = state["Flex49"]
		self.Projects = state["Projects"]
		self.ProjectHero = state["ProjectHero"]
		self.Flex53 = state["Flex53"]
		self.projButtons = state["projButtons"]
		self.Pdwnbtn = state["Pdwnbtn"]
		self.PupBtn = state["PupBtn"]
		self.Flex196 = state["Flex196"]
		self.Flex197 = state["Flex197"]
		self.Flex198 = state["Flex198"]
		self.proj1MainImgF = state["proj1MainImgF"]
		self.projImgHolder1 = state["projImgHolder1"]
		...
		self.proj2MainImgF = state["proj2MainImgF"]
		self.projImgHolder2 = state["projImgHolder2"]
		self.Flex217 = state["Flex217"]
		self.Flex215 = state["Flex215"]
		self.Flex214 = state["Flex214"]
		self.projMainImgF = state["projMainImgF"]
		self.projImgHolder3 = state["projImgHolder3"]
		self.Flex222 = state["Flex222"]
		self.Flex223 = state["Flex223"]
		self.Flex224 = state["Flex224"]
		self.Blogs = state["Blogs"]
		self.BlogsBody = state["BlogsBody"]
		self.RightArticles = state["RightArticles"]
		...
		self.ArticleBody2 = state["ArticleBody2"]
		self.Flex65 = state["Flex65"]
		self.Flex66 = state["Flex66"]
		self.Flex59 = state["Flex59"]
		self.ArticlesBody = state["ArticlesBody"]
		self.ReadBlog = state["ReadBlog"]
		self.Flex60 = state["Flex60"]
		self.DateMin = state["DateMin"]
		self.LeftHeading = state["LeftHeading"]
		self.Flex74 = state["Flex74"]
		self.Experiencebox = state["Experiencebox"]
		self.expMain = state["expMain"]
		self.exptRight = state["exptRight"]
		...
		self.rightHead = state["rightHead"]
		self.expLeft = state["expLeft"]
		self.colleges = state["colleges"]
		self.Flex137 = state["Flex137"]
		self.college1 = state["college1"]
		...
		self.leftHead = state["leftHead"]
		self.Testimonials = state["Testimonials"]
		self.TestiMain = state["TestiMain"]
		self.testiContent = state["testiContent"]
		self.testiRight = state["testiRight"]
		self.trBottom = state["trBottom"]
		self.Flex146 = state["Flex146"]
		self.Flex147 = state["Flex147"]
		self.trTop = state["trTop"]
		self.TestiImg = state["TestiImg"]
		self.testihead = state["testihead"]
		self.FAQ = state["FAQ"]
		self.footer = state["footer"]
		self.faqContact = state["faqContact"]
		self.links = state["links"]
		self.contactLinks = state["contactLinks"]
		self.Flex185 = state["Flex185"]
		self.Flex188 = state["Flex188"]
		self.Flex189 = state["Flex189"]
		self.contactMe = state["contactMe"]
		self.Flex159 = state["Flex159"]
		self.contactHeading = state["contactHeading"]
		self.contactHeadColor = state["contactHeadColor"]
		self.faqs = state["faqs"]
		self.faqsRight = state["faqsRight"]
		self.faq5 = state["faq5"]
		self.Faq6 = state["Faq6"]
		self.Faq8 = state["Faq8"]
		self.Faq9 = state["Faq9"]
		self.faqsLeft = state["faqsLeft"]
		self.Faq4 = state["Faq4"]
		self.Faq3 = state["Faq3"]
		self.Faq2 = state["Faq2"]
		self.Faq1 = state["Faq1"]
		self.faqHead = state["faqHead"]
		self.Aboutme = state["Aboutme"]
		self.AboutImages = state["AboutImages"]
		self.Fimg3 = state["Fimg3"]
		self.Img2 = state["Img2"]
		self.img1 = state["img1"]
		self.AboutHero = state["AboutHero"]
		self.Righthead = state["Righthead"]
		self.LeftHead = state["LeftHead"]
		...
		self.TalkNow = state["TalkNow"]
		self.subhead = state["subhead"]
		...
		self.projHead = state["projHead"]
		self.TextBox43 = state["TextBox43"]
		self.ViewProj = state["ViewProj"]
		self.TextBox135 = state["TextBox135"]
		self.pImage1 = state["pImage1"]
		self.TextBox136 = state["TextBox136"]
		self.projHead1 = state["projHead1"]
		self.proj1 = state["proj1"]
		self.Image69 = state["Image69"]
		self.projHead2 = state["projHead2"]
		self.TextBox139 = state["TextBox139"]
		self.Image70 = state["Image70"]
		self.proj2 = state["proj2"]
		self.pImage2 = state["pImage2"]
		self.projHead3 = state["projHead3"]
		self.TextBox141 = state["TextBox141"]
		self.Image72 = state["Image72"]
		self.proj3 = state["proj3"]
		self.pImage3 = state["pImage3"]
		...
		self.testiheading = state["testiheading"]
		...
		self.dribbble = state["dribbble"]
		self.insta = state["insta"]
		self.blog = state["blog"]
		self.ervices = state["ervices"]
	...
	@property
	def navbarFlex(self):
		self._getter_access_tracker["navbarFlex"] = {}
		return self._navbarFlex
	@navbarFlex.setter
	def navbarFlex(self, new_state):
		self._setter_access_tracker["navbarFlex"] = {}
		global default_state
		self._navbarFlex = Flex(new_state, default_state["navbarFlex"])
	...
	@property
	def logo_flex(self):
		self._getter_access_tracker["logo_flex"] = {}
		return self._logo_flex
	@logo_flex.setter
	def logo_flex(self, new_state):
		self._setter_access_tracker["logo_flex"] = {}
		global default_state
		self._logo_flex = Flex(new_state, default_state["logo_flex"])
	...
	@property
	def Hero2(self):
		self._getter_access_tracker["Hero2"] = {}
		return self._Hero2
	@Hero2.setter
	def Hero2(self, new_state):
		self._setter_access_tracker["Hero2"] = {}
		global default_state
		self._Hero2 = Flex(new_state, default_state["Hero2"])

	@property
	def Hero1(self):
		self._getter_access_tracker["Hero1"] = {}
		return self._Hero1
	@Hero1.setter
	def Hero1(self, new_state):
		self._setter_access_tracker["Hero1"] = {}
		global default_state
		self._Hero1 = Flex(new_state, default_state["Hero1"])

	@property
	def submitCV(self):
		self._getter_access_tracker["submitCV"] = {}
		return self._submitCV
	@submitCV.setter
	def submitCV(self, new_state):
		self._setter_access_tracker["submitCV"] = {}
		global default_state
		self._submitCV = Flex(new_state, default_state["submitCV"])
	...
	def DownloadCV(self, new_state):
		...
		global default_state
		self._DownloadCV = Flex(new_state, default_state["DownloadCV"])
	...
	@property
	def upBtn(self):
		self._getter_access_tracker["upBtn"] = {}
		return self._upBtn
	@upBtn.setter
	def upBtn(self, new_state):
		self._setter_access_tracker["upBtn"] = {}
		global default_state
		self._upBtn = Div(new_state, default_state["upBtn"])

	@property
	def dwnBtn(self):
		self._getter_access_tracker["dwnBtn"] = {}
		return self._dwnBtn
	@dwnBtn.setter
	def dwnBtn(self, new_state):
		self._setter_access_tracker["dwnBtn"] = {}
		global default_state
		self._dwnBtn = Div(new_state, default_state["dwnBtn"])
	...
	@property
	def Trused(self):
		self._getter_access_tracker["Trused"] = {}
		return self._Trused
	@Trused.setter
	def Trused(self, new_state):
		self._setter_access_tracker["Trused"] = {}
		global default_state
		self._Trused = Flex(new_state, default_state["Trused"])
	...
	@property
	def comp(self):
		self._getter_access_tracker["comp"] = {}
		return self._comp
	@comp.setter
	def comp(self, new_state):
		self._setter_access_tracker["comp"] = {}
		global default_state
		self._comp = Flex(new_state, default_state["comp"])
	...
	@property
	def ServiceFlex(self):
		self._getter_access_tracker["ServiceFlex"] = {}
		return self._ServiceFlex
	@ServiceFlex.setter
	def ServiceFlex(self, new_state):
		self._setter_access_tracker["ServiceFlex"] = {}
		global default_state
		self._ServiceFlex = Flex(new_state, default_state["ServiceFlex"])

	@property
	def ServiceBody(self):
		self._getter_access_tracker["ServiceBody"] = {}
		return self._ServiceBody
	@ServiceBody.setter
	def ServiceBody(self, new_state):
		self._setter_access_tracker["ServiceBody"] = {}
		global default_state
		self._ServiceBody = Flex(new_state, default_state["ServiceBody"])
	...
	def Card2(self, new_state):
		...
		global default_state
		self._Card2 = Flex(new_state, default_state["Card2"])
	...
	@property
	def ServiceHead(self):
		self._getter_access_tracker["ServiceHead"] = {}
		return self._ServiceHead
	@ServiceHead.setter
	def ServiceHead(self, new_state):
		self._setter_access_tracker["ServiceHead"] = {}
		global default_state
		self._ServiceHead = Flex(new_state, default_state["ServiceHead"])
	...
	@property
	def ProjectHero(self):
		self._getter_access_tracker["ProjectHero"] = {}
		return self._ProjectHero
	@ProjectHero.setter
	def ProjectHero(self, new_state):
		self._setter_access_tracker["ProjectHero"] = {}
		global default_state
		self._ProjectHero = Flex(new_state, default_state["ProjectHero"])
	...
	@property
	def projButtons(self):
		self._getter_access_tracker["projButtons"] = {}
		return self._projButtons
	@projButtons.setter
	def projButtons(self, new_state):
		self._setter_access_tracker["projButtons"] = {}
		global default_state
		self._projButtons = Flex(new_state, default_state["projButtons"])

	@property
	def Pdwnbtn(self):
		self._getter_access_tracker["Pdwnbtn"] = {}
		return self._Pdwnbtn
	@Pdwnbtn.setter
	def Pdwnbtn(self, new_state):
		self._setter_access_tracker["Pdwnbtn"] = {}
		global default_state
		self._Pdwnbtn = Div(new_state, default_state["Pdwnbtn"])

	@property
	def PupBtn(self):
		self._getter_access_tracker["PupBtn"] = {}
		return self._PupBtn
	@PupBtn.setter
	def PupBtn(self, new_state):
		self._setter_access_tracker["PupBtn"] = {}
		global default_state
		self._PupBtn = Div(new_state, default_state["PupBtn"])
	...
	@property
	def proj1MainImgF(self):
		self._getter_access_tracker["proj1MainImgF"] = {}
		return self._proj1MainImgF
	@proj1MainImgF.setter
	def proj1MainImgF(self, new_state):
		self._setter_access_tracker["proj1MainImgF"] = {}
		global default_state
		self._proj1MainImgF = Flex(new_state, default_state["proj1MainImgF"])

	@property
	def projImgHolder1(self):
		self._getter_access_tracker["projImgHolder1"] = {}
		return self._projImgHolder1
	@projImgHolder1.setter
	def projImgHolder1(self, new_state):
		self._setter_access_tracker["projImgHolder1"] = {}
		global default_state
		self._projImgHolder1 = Div(new_state, default_state["projImgHolder1"])
	...
	@property
	def proj2MainImgF(self):
		self._getter_access_tracker["proj2MainImgF"] = {}
		return self._proj2MainImgF
	@proj2MainImgF.setter
	def proj2MainImgF(self, new_state):
		self._setter_access_tracker["proj2MainImgF"] = {}
		global default_state
		self._proj2MainImgF = Flex(new_state, default_state["proj2MainImgF"])

	@property
	def projImgHolder2(self):
		self._getter_access_tracker["projImgHolder2"] = {}
		return self._projImgHolder2
	@projImgHolder2.setter
	def projImgHolder2(self, new_state):
		self._setter_access_tracker["projImgHolder2"] = {}
		global default_state
		self._projImgHolder2 = Div(new_state, default_state["projImgHolder2"])
	...
	@property
	def projMainImgF(self):
		self._getter_access_tracker["projMainImgF"] = {}
		return self._projMainImgF
	@projMainImgF.setter
	def projMainImgF(self, new_state):
		self._setter_access_tracker["projMainImgF"] = {}
		global default_state
		self._projMainImgF = Flex(new_state, default_state["projMainImgF"])

	@property
	def projImgHolder3(self):
		self._getter_access_tracker["projImgHolder3"] = {}
		return self._projImgHolder3
	@projImgHolder3.setter
	def projImgHolder3(self, new_state):
		self._setter_access_tracker["projImgHolder3"] = {}
		global default_state
		self._projImgHolder3 = Div(new_state, default_state["projImgHolder3"])
	...
	@property
	def BlogsBody(self):
		self._getter_access_tracker["BlogsBody"] = {}
		return self._BlogsBody
	@BlogsBody.setter
	def BlogsBody(self, new_state):
		self._setter_access_tracker["BlogsBody"] = {}
		global default_state
		self._BlogsBody = Flex(new_state, default_state["BlogsBody"])

	@property
	def RightArticles(self):
		self._getter_access_tracker["RightArticles"] = {}
		return self._RightArticles
	@RightArticles.setter
	def RightArticles(self, new_state):
		self._setter_access_tracker["RightArticles"] = {}
		global default_state
		self._RightArticles = Flex(new_state, default_state["RightArticles"])
	...
	@property
	def ArticleBody2(self):
		self._getter_access_tracker["ArticleBody2"] = {}
		return self._ArticleBody2
	@ArticleBody2.setter
	def ArticleBody2(self, new_state):
		self._setter_access_tracker["ArticleBody2"] = {}
		global default_state
		self._ArticleBody2 = Flex(new_state, default_state["ArticleBody2"])
	...
	@property
	def ArticlesBody(self):
		self._getter_access_tracker["ArticlesBody"] = {}
		return self._ArticlesBody
	@ArticlesBody.setter
	def ArticlesBody(self, new_state):
		self._setter_access_tracker["ArticlesBody"] = {}
		global default_state
		self._ArticlesBody = Flex(new_state, default_state["ArticlesBody"])

	@property
	def ReadBlog(self):
		self._getter_access_tracker["ReadBlog"] = {}
		return self._ReadBlog
	@ReadBlog.setter
	def ReadBlog(self, new_state):
		self._setter_access_tracker["ReadBlog"] = {}
		global default_state
		self._ReadBlog = Flex(new_state, default_state["ReadBlog"])
	...
	@property
	def DateMin(self):
		self._getter_access_tracker["DateMin"] = {}
		return self._DateMin
	@DateMin.setter
	def DateMin(self, new_state):
		self._setter_access_tracker["DateMin"] = {}
		global default_state
		self._DateMin = Flex(new_state, default_state["DateMin"])

	@property
	def LeftHeading(self):
		self._getter_access_tracker["LeftHeading"] = {}
		return self._LeftHeading
	@LeftHeading.setter
	def LeftHeading(self, new_state):
		self._setter_access_tracker["LeftHeading"] = {}
		global default_state
		self._LeftHeading = Flex(new_state, default_state["LeftHeading"])
	...
	@property
	def Experiencebox(self):
		self._getter_access_tracker["Experiencebox"] = {}
		return self._Experiencebox
	@Experiencebox.setter
	def Experiencebox(self, new_state):
		self._setter_access_tracker["Experiencebox"] = {}
		global default_state
		self._Experiencebox = Flex(new_state, default_state["Experiencebox"])

	@property
	def expMain(self):
		self._getter_access_tracker["expMain"] = {}
		return self._expMain
	@expMain.setter
	def expMain(self, new_state):
		self._setter_access_tracker["expMain"] = {}
		global default_state
		self._expMain = Flex(new_state, default_state["expMain"])

	@property
	def exptRight(self):
		self._getter_access_tracker["exptRight"] = {}
		return self._exptRight
	@exptRight.setter
	def exptRight(self, new_state):
		self._setter_access_tracker["exptRight"] = {}
		global default_state
		self._exptRight = Flex(new_state, default_state["exptRight"])
	...
	@property
	def rightHead(self):
		self._getter_access_tracker["rightHead"] = {}
		return self._rightHead
	@rightHead.setter
	def rightHead(self, new_state):
		self._setter_access_tracker["rightHead"] = {}
		global default_state
		self._rightHead = Flex(new_state, default_state["rightHead"])

	@property
	def expLeft(self):
		self._getter_access_tracker["expLeft"] = {}
		return self._expLeft
	@expLeft.setter
	def expLeft(self, new_state):
		self._setter_access_tracker["expLeft"] = {}
		global default_state
		self._expLeft = Flex(new_state, default_state["expLeft"])

	@property
	def colleges(self):
		self._getter_access_tracker["colleges"] = {}
		return self._colleges
	@colleges.setter
	def colleges(self, new_state):
		self._setter_access_tracker["colleges"] = {}
		global default_state
		self._colleges = Flex(new_state, default_state["colleges"])
	...
	@property
	def college1(self):
		self._getter_access_tracker["college1"] = {}
		return self._college1
	@college1.setter
	def college1(self, new_state):
		self._setter_access_tracker["college1"] = {}
		global default_state
		self._college1 = Flex(new_state, default_state["college1"])
	...
	@property
	def leftHead(self):
		self._getter_access_tracker["leftHead"] = {}
		return self._leftHead
	@leftHead.setter
	def leftHead(self, new_state):
		self._setter_access_tracker["leftHead"] = {}
		global default_state
		self._leftHead = Flex(new_state, default_state["leftHead"])
	...
	@property
	def TestiMain(self):
		self._getter_access_tracker["TestiMain"] = {}
		return self._TestiMain
	@TestiMain.setter
	def TestiMain(self, new_state):
		self._setter_access_tracker["TestiMain"] = {}
		global default_state
		self._TestiMain = Flex(new_state, default_state["TestiMain"])

	@property
	def testiContent(self):
		self._getter_access_tracker["testiContent"] = {}
		return self._testiContent
	@testiContent.setter
	def testiContent(self, new_state):
		self._setter_access_tracker["testiContent"] = {}
		global default_state
		self._testiContent = Flex(new_state, default_state["testiContent"])

	@property
	def testiRight(self):
		self._getter_access_tracker["testiRight"] = {}
		return self._testiRight
	@testiRight.setter
	def testiRight(self, new_state):
		self._setter_access_tracker["testiRight"] = {}
		global default_state
		self._testiRight = Flex(new_state, default_state["testiRight"])

	@property
	def trBottom(self):
		self._getter_access_tracker["trBottom"] = {}
		return self._trBottom
	@trBottom.setter
	def trBottom(self, new_state):
		self._setter_access_tracker["trBottom"] = {}
		global default_state
		self._trBottom = Flex(new_state, default_state["trBottom"])
	...
	@property
	def trTop(self):
		self._getter_access_tracker["trTop"] = {}
		return self._trTop
	@trTop.setter
	def trTop(self, new_state):
		self._setter_access_tracker["trTop"] = {}
		global default_state
		self._trTop = Flex(new_state, default_state["trTop"])

	@property
	def TestiImg(self):
		self._getter_access_tracker["TestiImg"] = {}
		return self._TestiImg
	@TestiImg.setter
	def TestiImg(self, new_state):
		self._setter_access_tracker["TestiImg"] = {}
		global default_state
		self._TestiImg = Flex(new_state, default_state["TestiImg"])

	@property
	def testihead(self):
		self._getter_access_tracker["testihead"] = {}
		return self._testihead
	@testihead.setter
	def testihead(self, new_state):
		self._setter_access_tracker["testihead"] = {}
		global default_state
		self._testihead = Flex(new_state, default_state["testihead"])
	...
	@property
	def faqContact(self):
		self._getter_access_tracker["faqContact"] = {}
		return self._faqContact
	@faqContact.setter
	def faqContact(self, new_state):
		self._setter_access_tracker["faqContact"] = {}
		global default_state
		self._faqContact = Flex(new_state, default_state["faqContact"])
	...
	@property
	def contactLinks(self):
		self._getter_access_tracker["contactLinks"] = {}
		return self._contactLinks
	@contactLinks.setter
	def contactLinks(self, new_state):
		self._setter_access_tracker["contactLinks"] = {}
		global default_state
		self._contactLinks = Flex(new_state, default_state["contactLinks"])
	...
	@property
	def contactMe(self):
		self._getter_access_tracker["contactMe"] = {}
		return self._contactMe
	@contactMe.setter
	def contactMe(self, new_state):
		self._setter_access_tracker["contactMe"] = {}
		global default_state
		self._contactMe = Flex(new_state, default_state["contactMe"])
	...
	@property
	def contactHeading(self):
		self._getter_access_tracker["contactHeading"] = {}
		return self._contactHeading
	@contactHeading.setter
	def contactHeading(self, new_state):
		self._setter_access_tracker["contactHeading"] = {}
		global default_state
		self._contactHeading = Flex(new_state, default_state["contactHeading"])

	@property
	def contactHeadColor(self):
		self._getter_access_tracker["contactHeadColor"] = {}
		return self._contactHeadColor
	@contactHeadColor.setter
	def contactHeadColor(self, new_state):
		self._setter_access_tracker["contactHeadColor"] = {}
		global default_state
		self._contactHeadColor = Flex(new_state, default_state["contactHeadColor"])
	...
	def faqs(self, new_state):
		...
		global default_state
		self._faqs = Flex(new_state, default_state["faqs"])

	@property
	def faqsRight(self):
		self._getter_access_tracker["faqsRight"] = {}
		return self._faqsRight
	@faqsRight.setter
	def faqsRight(self, new_state):
		self._setter_access_tracker["faqsRight"] = {}
		global default_state
		self._faqsRight = Flex(new_state, default_state["faqsRight"])

	@property
	def faq5(self):
		self._getter_access_tracker["faq5"] = {}
		return self._faq5
	@faq5.setter
	def faq5(self, new_state):
		self._setter_access_tracker["faq5"] = {}
		global default_state
		self._faq5 = Flex(new_state, default_state["faq5"])

	@property
	def Faq6(self):
		self._getter_access_tracker["Faq6"] = {}
		return self._Faq6
	@Faq6.setter
	def Faq6(self, new_state):
		self._setter_access_tracker["Faq6"] = {}
		global default_state
		self._Faq6 = Flex(new_state, default_state["Faq6"])

	@property
	def Faq8(self):
		self._getter_access_tracker["Faq8"] = {}
		return self._Faq8
	@Faq8.setter
	def Faq8(self, new_state):
		self._setter_access_tracker["Faq8"] = {}
		global default_state
		self._Faq8 = Flex(new_state, default_state["Faq8"])

	@property
	def Faq9(self):
		self._getter_access_tracker["Faq9"] = {}
		return self._Faq9
	@Faq9.setter
	def Faq9(self, new_state):
		self._setter_access_tracker["Faq9"] = {}
		global default_state
		self._Faq9 = Flex(new_state, default_state["Faq9"])

	@property
	def faqsLeft(self):
		self._getter_access_tracker["faqsLeft"] = {}
		return self._faqsLeft
	@faqsLeft.setter
	def faqsLeft(self, new_state):
		self._setter_access_tracker["faqsLeft"] = {}
		global default_state
		self._faqsLeft = Flex(new_state, default_state["faqsLeft"])

	@property
	def Faq4(self):
		self._getter_access_tracker["Faq4"] = {}
		return self._Faq4
	@Faq4.setter
	def Faq4(self, new_state):
		self._setter_access_tracker["Faq4"] = {}
		global default_state
		self._Faq4 = Flex(new_state, default_state["Faq4"])

	@property
	def Faq3(self):
		self._getter_access_tracker["Faq3"] = {}
		return self._Faq3
	@Faq3.setter
	def Faq3(self, new_state):
		self._setter_access_tracker["Faq3"] = {}
		global default_state
		self._Faq3 = Flex(new_state, default_state["Faq3"])

	@property
	def Faq2(self):
		self._getter_access_tracker["Faq2"] = {}
		return self._Faq2
	@Faq2.setter
	def Faq2(self, new_state):
		self._setter_access_tracker["Faq2"] = {}
		global default_state
		self._Faq2 = Flex(new_state, default_state["Faq2"])

	@property
	def Faq1(self):
		self._getter_access_tracker["Faq1"] = {}
		return self._Faq1
	@Faq1.setter
	def Faq1(self, new_state):
		self._setter_access_tracker["Faq1"] = {}
		global default_state
		self._Faq1 = Flex(new_state, default_state["Faq1"])
	...
	@property
	def Aboutme(self):
		self._getter_access_tracker["Aboutme"] = {}
		return self._Aboutme
	@Aboutme.setter
	def Aboutme(self, new_state):
		self._setter_access_tracker["Aboutme"] = {}
		global default_state
		self._Aboutme = Flex(new_state, default_state["Aboutme"])

	@property
	def AboutImages(self):
		self._getter_access_tracker["AboutImages"] = {}
		return self._AboutImages
	@AboutImages.setter
	def AboutImages(self, new_state):
		self._setter_access_tracker["AboutImages"] = {}
		global default_state
		self._AboutImages = Flex(new_state, default_state["AboutImages"])

	@property
	def Fimg3(self):
		self._getter_access_tracker["Fimg3"] = {}
		return self._Fimg3
	@Fimg3.setter
	def Fimg3(self, new_state):
		self._setter_access_tracker["Fimg3"] = {}
		global default_state
		self._Fimg3 = Flex(new_state, default_state["Fimg3"])
	...
	def Img2(self, new_state):
		...
		global default_state
		self._Img2 = Div(new_state, default_state["Img2"])
	...
	def img1(self, new_state):
		...
		global default_state
		self._img1 = Div(new_state, default_state["img1"])

	@property
	def AboutHero(self):
		self._getter_access_tracker["AboutHero"] = {}
		return self._AboutHero
	@AboutHero.setter
	def AboutHero(self, new_state):
		self._setter_access_tracker["AboutHero"] = {}
		global default_state
		self._AboutHero = Flex(new_state, default_state["AboutHero"])
	...
	def Booking(self, new_state):
		...
		global default_state
		self._Booking = Link(new_state, default_state["Booking"])
	...
	def Dot(self):
		...
		return self._Dot
	@Dot.setter
	def Dot(self, new_state):
		self._setter_access_tracker["Dot"] = {}
		global default_state
		self._Dot = TextBox(new_state, default_state["Dot"])
	...
	@property
	def dcv(self):
		self._getter_access_tracker["dcv"] = {}
		return self._dcv
	@dcv.setter
	def dcv(self, new_state):
		self._setter_access_tracker["dcv"] = {}
		global default_state
		self._dcv = Link(new_state, default_state["dcv"])
	...
	@property
	def TalkNow(self):
		self._getter_access_tracker["TalkNow"] = {}
		return self._TalkNow
	@TalkNow.setter
	def TalkNow(self, new_state):
		self._setter_access_tracker["TalkNow"] = {}
		global default_state
		self._TalkNow = TextBox(new_state, default_state["TalkNow"])

	@property
	def subhead(self):
		self._getter_access_tracker["subhead"] = {}
		return self._subhead
	@subhead.setter
	def subhead(self, new_state):
		self._setter_access_tracker["subhead"] = {}
		global default_state
		self._subhead = TextBox(new_state, default_state["subhead"])
	...
	@property
	def projHead(self):
		self._getter_access_tracker["projHead"] = {}
		return self._projHead
	@projHead.setter
	def projHead(self, new_state):
		self._setter_access_tracker["projHead"] = {}
		global default_state
		self._projHead = TextBox(new_state, default_state["projHead"])
	...
	@property
	def ViewProj(self):
		self._getter_access_tracker["ViewProj"] = {}
		return self._ViewProj
	@ViewProj.setter
	def ViewProj(self, new_state):
		self._setter_access_tracker["ViewProj"] = {}
		global default_state
		self._ViewProj = TextBox(new_state, default_state["ViewProj"])
	...
	@property
	def pImage1(self):
		self._getter_access_tracker["pImage1"] = {}
		return self._pImage1
	@pImage1.setter
	def pImage1(self, new_state):
		self._setter_access_tracker["pImage1"] = {}
		global default_state
		self._pImage1 = Image(new_state, default_state["pImage1"])
	...
	@property
	def projHead1(self):
		self._getter_access_tracker["projHead1"] = {}
		return self._projHead1
	@projHead1.setter
	def projHead1(self, new_state):
		self._setter_access_tracker["projHead1"] = {}
		global default_state
		self._projHead1 = TextBox(new_state, default_state["projHead1"])

	@property
	def proj1(self):
		self._getter_access_tracker["proj1"] = {}
		return self._proj1
	@proj1.setter
	def proj1(self, new_state):
		self._setter_access_tracker["proj1"] = {}
		global default_state
		self._proj1 = Link(new_state, default_state["proj1"])
	...
	@property
	def projHead2(self):
		self._getter_access_tracker["projHead2"] = {}
		return self._projHead2
	@projHead2.setter
	def projHead2(self, new_state):
		self._setter_access_tracker["projHead2"] = {}
		global default_state
		self._projHead2 = TextBox(new_state, default_state["projHead2"])
	...
	@property
	def proj2(self):
		self._getter_access_tracker["proj2"] = {}
		return self._proj2
	@proj2.setter
	def proj2(self, new_state):
		self._setter_access_tracker["proj2"] = {}
		global default_state
		self._proj2 = Link(new_state, default_state["proj2"])

	@property
	def pImage2(self):
		self._getter_access_tracker["pImage2"] = {}
		return self._pImage2
	@pImage2.setter
	def pImage2(self, new_state):
		self._setter_access_tracker["pImage2"] = {}
		global default_state
		self._pImage2 = Image(new_state, default_state["pImage2"])

	@property
	def projHead3(self):
		self._getter_access_tracker["projHead3"] = {}
		return self._projHead3
	@projHead3.setter
	def projHead3(self, new_state):
		self._setter_access_tracker["projHead3"] = {}
		global default_state
		self._projHead3 = TextBox(new_state, default_state["projHead3"])
	...
	@property
	def proj3(self):
		self._getter_access_tracker["proj3"] = {}
		return self._proj3
	@proj3.setter
	def proj3(self, new_state):
		self._setter_access_tracker["proj3"] = {}
		global default_state
		self._proj3 = Link(new_state, default_state["proj3"])

	@property
	def pImage3(self):
		self._getter_access_tracker["pImage3"] = {}
		return self._pImage3
	@pImage3.setter
	def pImage3(self, new_state):
		self._setter_access_tracker["pImage3"] = {}
		global default_state
		self._pImage3 = Image(new_state, default_state["pImage3"])
	...
	@property
	def testiheading(self):
		self._getter_access_tracker["testiheading"] = {}
		return self._testiheading
	@testiheading.setter
	def testiheading(self, new_state):
		self._setter_access_tracker["testiheading"] = {}
		global default_state
		self._testiheading = TextBox(new_state, default_state["testiheading"])
	...
	def contact(self, new_state):
		...
		global default_state
		self._contact = Link(new_state, default_state["contact"])

	@property
	def dribbble(self):
		self._getter_access_tracker["dribbble"] = {}
		return self._dribbble
	@dribbble.setter
	def dribbble(self, new_state):
		self._setter_access_tracker["dribbble"] = {}
		global default_state
		self._dribbble = Link(new_state, default_state["dribbble"])

	@property
	def insta(self):
		self._getter_access_tracker["insta"] = {}
		return self._insta
	@insta.setter
	def insta(self, new_state):
		self._setter_access_tracker["insta"] = {}
		global default_state
		self._insta = Link(new_state, default_state["insta"])
	...
	@property
	def ervices(self):
		self._getter_access_tracker["ervices"] = {}
		return self._ervices
	@ervices.setter
	def ervices(self, new_state):
		self._setter_access_tracker["ervices"] = {}
		global default_state
		self._ervices = Link(new_state, default_state["ervices"])
	...
	def project(self, new_state):
		...
		global default_state
		self._project = Link(new_state, default_state["project"])
	...
	def experience(self, new_state):
		...
		global default_state
		self._experience = Link(new_state, default_state["experience"])
	...
	@property
	def faqHeading(self):
		self._getter_access_tracker["faqHeading"] = {}
		return self._faqHeading
	@faqHeading.setter
	def faqHeading(self, new_state):
		self._setter_access_tracker["faqHeading"] = {}
		global default_state
		self._faqHeading = TextBox(new_state, default_state["faqHeading"])
	...
	@property
	def Righttext(self):
		self._getter_access_tracker["Righttext"] = {}
		return self._Righttext
	@Righttext.setter
	def Righttext(self, new_state):
		self._setter_access_tracker["Righttext"] = {}
		global default_state
		self._Righttext = TextBox(new_state, default_state["Righttext"])

	@property
	def ProdDes(self):
		self._getter_access_tracker["ProdDes"] = {}
		return self._ProdDes
	@ProdDes.setter
	def ProdDes(self, new_state):
		self._setter_access_tracker["ProdDes"] = {}
		global default_state
		self._ProdDes = TextBox(new_state, default_state["ProdDes"])
	...
	def _to_json_fields(self):
		return {
			"Navbar": self._Navbar,
			"navbarFlex": self._navbarFlex,
			"NavLinks": self._NavLinks,
			"Flex14": self._Flex14,
			"logo_flex": self._logo_flex,
			"Hero": self._Hero,
			"Flex28": self._Flex28,
			"Hero2": self._Hero2,
			"Hero1": self._Hero1,
			"submitCV": self._submitCV,
			...
			"ServiceFlex": self._ServiceFlex,
			"ServiceBody": self._ServiceBody,
			"Card3": self._Card3,
			"Flex43": self._Flex43,
			"Flex34": self._Flex34,
			"Flex35": self._Flex35,
			...
			"Flex41": self._Flex41,
			"Flex42": self._Flex42,
			"ServiceHead": self._ServiceHead,
			"Flex49": self._Flex49,
			"Projects": self._Projects,
			"ProjectHero": self._ProjectHero,
			"Flex53": self._Flex53,
			"projButtons": self._projButtons,
			"Pdwnbtn": self._Pdwnbtn,
			"PupBtn": self._PupBtn,
			"Flex196": self._Flex196,
			"Flex197": self._Flex197,
			"Flex198": self._Flex198,
			"proj1MainImgF": self._proj1MainImgF,
			"projImgHolder1": self._projImgHolder1,
			"Flex202": self._Flex202,
			"Flex209": self._Flex209,
			"Flex213": self._Flex213,
			"Flex211": self._Flex211,
			"Flex210": self._Flex210,
			"proj2MainImgF": self._proj2MainImgF,
			"projImgHolder2": self._projImgHolder2,
			"Flex217": self._Flex217,
			"Flex215": self._Flex215,
			"Flex214": self._Flex214,
			"projMainImgF": self._projMainImgF,
			"projImgHolder3": self._projImgHolder3,
			"Flex222": self._Flex222,
			"Flex223": self._Flex223,
			"Flex224": self._Flex224,
			"Blogs": self._Blogs,
			"BlogsBody": self._BlogsBody,
			"RightArticles": self._RightArticles,
			...
			"Flex64": self._Flex64,
			"Flex58": self._Flex58,
			"ArticleBody2": self._ArticleBody2,
			"Flex65": self._Flex65,
			"Flex66": self._Flex66,
			"Flex59": self._Flex59,
			"ArticlesBody": self._ArticlesBody,
			"ReadBlog": self._ReadBlog,
			"Flex60": self._Flex60,
			"DateMin": self._DateMin,
			"LeftHeading": self._LeftHeading,
			"Flex74": self._Flex74,
			"Experiencebox": self._Experiencebox,
			"expMain": self._expMain,
			"exptRight": self._exptRight,
			...
			"rightHead": self._rightHead,
			"expLeft": self._expLeft,
			"colleges": self._colleges,
			"Flex137": self._Flex137,
			"college1": self._college1,
			...
			"leftHead": self._leftHead,
			"Testimonials": self._Testimonials,
			"TestiMain": self._TestiMain,
			"testiContent": self._testiContent,
			"testiRight": self._testiRight,
			"trBottom": self._trBottom,
			"Flex146": self._Flex146,
			"Flex147": self._Flex147,
			"trTop": self._trTop,
			"TestiImg": self._TestiImg,
			"testihead": self._testihead,
			"FAQ": self._FAQ,
			"footer": self._footer,
			"faqContact": self._faqContact,
			"links": self._links,
			"contactLinks": self._contactLinks,
			"Flex185": self._Flex185,
			"Flex188": self._Flex188,
			"Flex189": self._Flex189,
			"contactMe": self._contactMe,
			"Flex159": self._Flex159,
			"contactHeading": self._contactHeading,
			"contactHeadColor": self._contactHeadColor,
			"faqs": self._faqs,
			"faqsRight": self._faqsRight,
			"faq5": self._faq5,
			"Faq6": self._Faq6,
			"Faq8": self._Faq8,
			"Faq9": self._Faq9,
			"faqsLeft": self._faqsLeft,
			"Faq4": self._Faq4,
			"Faq3": self._Faq3,
			"Faq2": self._Faq2,
			"Faq1": self._Faq1,
			...
			"AboutImages": self._AboutImages,
			"Fimg3": self._Fimg3,
			"Img2": self._Img2,
			"img1": self._img1,
			"AboutHero": self._AboutHero,
			"Righthead": self._Righthead,
			"LeftHead": self._LeftHead,
			...
			"TalkNow": self._TalkNow,
			"subhead": self._subhead,
			...
			"testiheading": self._testiheading,
			...
			"dribbble": self._dribbble,
			"insta": self._insta,
			"blog": self._blog,
			"ervices": self._ervices,
			"Link47": self._Link47,
